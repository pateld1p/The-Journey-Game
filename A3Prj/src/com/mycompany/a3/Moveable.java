...
public abstract class Moveable extends GameObject{
	...
	public Moveable(int size, Point location, int r, int g, int b, int heading, int speed) {
	...
	public abstract void move(int heading, int speed, int width, int height, int elapsedTime);
}
